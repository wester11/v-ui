...
const EN: Dict = {
  ...
  servers_onboard_hint_new:  'Script is fetched from GitHub (valid SSL). It installs Docker, builds the agent and connects to the panel automatically.',
  servers_onboard_cmd_hint:  'Token encodes: panel URL + node ID + secret key',
  servers_onboard_step2_new: 'Run command on your VPS as root',
  servers_onboard_run_hint:  'paste the command above into your VPS terminal (SSH)',
  ...
  settings_update_running:    'Updating...',
...
const RU: Dict = {
  ...
  servers_onboard_hint_new:  'Скрипт скачивается с GitHub (валидный SSL). Устанавливает Docker, собирает агент и подключается к панели автоматически.',
  servers_onboard_cmd_hint:  'Токен содержит: адрес панели + ID ноды + секретный ключ',
  servers_onboard_step2_new: 'Выполните команду на VPS под root',
  servers_onboard_run_hint:  'вставьте команду выше в терминал VPS (SSH)',
  ...
  settings_update_running:    'Обновляю...',
